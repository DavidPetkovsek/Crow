...
*/
    ...
    public:
        ...
        void handle_upgrade(const request& req, response& res, Adaptor&& adaptor)
        {
            ...
            CROW_LOG_DEBUG << "Matched rule (upgrade) '" << rules[rule_index]->rule_ << "' " << static_cast<uint64_t>(req.method) << " / " << rules[rule_index]->get_methods();
        ...
        void handle(request& req, response& res, routing_handle_result found)
        {
            ...
            CROW_LOG_DEBUG << "Matched rule '" << rules[rule_index]->rule_ << "' " << static_cast<uint64_t>(req.method) << " / " << rules[rule_index]->get_methods();
